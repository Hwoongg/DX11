...
bool CubeModelClass::Initialize(ID3D11Device* device, const char* modelFilename, const WCHAR* textureFilename)
{
	bool result;
...
bool CubeModelClass::LoadTexture(ID3D11Device* device, const WCHAR* filename)
{
	bool result;
...
bool CubeModelClass::LoadModel(const char* filename)
{
	ifstream fin;
	char input;
	int i;
