...
bool LightShaderClass::InitializeShader(ID3D11Device* device, const HWND hwnd, 
...
void LightShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, 
